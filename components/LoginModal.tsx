          ...
          <div className="p-6">
            {activeTab === 'client' ? (
              <form onSubmit={handleClientSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input
                      type="text"
                      required
                      className="bg-white text-gray-900 focus:ring-brand-primary focus:border-brand-primary block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-3"
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-primary hover:bg-brand-dark focus:outline-none transition-colors mt-4"
                >
                  Continuar
                </button>
              </form>
              ...
              <form onSubmit={handleAdminSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-900 focus:outline-none transition-colors mt-4"
                >
                  Entrar al Panel
                </button>
              </form>
